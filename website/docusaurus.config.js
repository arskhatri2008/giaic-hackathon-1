...
const config = {
  ...
  organizationName: 'arskhatri2008', // Usually your GitHub org/user name.
  projectName: 'giaic-hackathon-1', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        {name: 'keywords', content: 'ROS 2, robotics, humanoid robots, AI, Physical AI, robot operating system, robot development, robotics education, AI integration, ROS architecture, robot communication, URDF, robot modeling'},
